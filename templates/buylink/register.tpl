                    ...
                    <fieldset class="user-detail">
                        <div class="control-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="firstName" style="margin-right: 5px" name="firstName" value="{$smarty.post.firstName}" class="col-sm-4 required">
                                    <input type="text" id="lastName" name="lastName" value="{$smarty.post.lastName}" class="col-sm-4 required">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label" for="username">User name <span>*</span></label>
                                <div class="col-sm-9">
                                    <input type="text" class="col-sm-4 required" id="username" name="username" value="{$smarty.post.username}" />
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="col-sm-4" id="company" name="company" value="{$smarty.post.company}" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label" for="email">Email address<span>*</span></label>
                                <div class="col-sm-9">
                                    <input type="text" class="col-sm-4 required email" value="{$smarty.post.email}" id="email" name="email" />
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="col-sm-4" value="{$smarty.post.mobile}" id="mobile" name="mobile" />
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-3 control-label">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="col-sm-4 required" value="{$smarty.post.address}" id="address" name="address" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label" for="city">City<span>*</span></label>
                                <div class="col-sm-9">
                                    <input type="text" class="col-sm-4 required" id="city" value="{$smarty.post.city}" name="city" />
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="col-sm-4 required" value="{$smarty.post.state}" id="state" name="state" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label" for="zip">Zip<span>*</span></label>
                                <div class="col-sm-9">
                                    <input type="text" class="col-sm-4 required" id="zip" value="{$smarty.post.zip}" name="zip" />
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-offset-3 col-sm-9">
