                                    ...
                                    <div class="tab-pane fade {if !$tabactive or $tabactive eq 2}active in{/if}" id="blmtab2">
                                        <form method="get" id="marketplaceFilter" class="form-horizontal">
                                            <div class="control-group">
                                                <div class="form-group">
                                                    <div class="col-sm-5">
                                                        <input type="text" class="col-sm-12 border-blue" name="keywords" value="{if $keywords}{$keywords}{else}Nhập từ khóa cần tìm{/if}" onfocus="updateTextFieldLabel(this, true, 'Nhập từ khóa cần tìm');" onblur="updateTextFieldLabel(this, false, 'Nhập từ khóa cần tìm');">

                                                    </div>
                                                    <div class="col-sm-4">
                                                        <select class="col-sm-12" id="filterCategory" name="adv_id" size="1">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input type="text" value="{if $buying_date}{$buying_date}{else}{$smarty.now|date_format:"%Y/%m/%d"}{/if}" name="buying_date" class="col-sm-12">
                                                    </div>
                                                    <label for="inputEmail3" class="col-sm-2 control-label"><strong>Đến:</strong></label>
                                                    <div class="col-sm-3">
                                                        <input type="text" value='{if $end_date}{$end_date}{else}{$smarty.now|date_format:"%Y/%m/%d"}{/if}' name="end_date" class="col-sm-12">
                                                    </div>
                                        ...
                                        <form method="get" id="marketplaceFilter" class="form-horizontal">
                                            <div class="control-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label for="inputEmail3" class="col-sm-2 control-label"><strong>Từ ngày:</strong></label>
                                                    <div class="col-sm-3">
                                                        <input type="text" value="{if $buying_date_expire}{$buying_date_expire}{else}{$smarty.now|date_format:"%Y/%m/%d"}{/if}" name="buying_date_expire" class="col-sm-12">
                                                    </div>
                                                    <label for="inputEmail3" class="col-sm-2 control-label"><strong>Đến:</strong></label>
                                                    <div class="col-sm-3">
                                                        <input type="text" value='{if $end_date_expire}{$end_date_expire}{else}{$smarty.now|date_format:"%Y/%m/%d"}{/if}' name="end_date_expire" class="col-sm-12">
                                                    </div>
